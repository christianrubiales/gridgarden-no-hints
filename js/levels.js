var levels = [
  {
    ...
    instructions: {
      'nh': '<p>Welcome to Grid Garden - No Hints, where you write CSS code to grow your carrot garden! If you want hints, just select a language at the bottom of this page.</p><p>Here are the CSS properties you need for this site:<ul><li><code>grid-area</code></li><li><code>grid-column</code></li><li><code>grid-column-end</code></li><li><code>grid-column-start</code></li><li><code>grid-row</code></li><li><code>grid-row-end</code></li><li><code>grid-row-start</code></li><li><code>grid-template</code></li><li><code>grid-template-areas</code></li><li><code>grid-template-columns</code></li><li><code>grid-template-rows</code></li><li><code>order</code></li></ul></p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Uh oh, looks like weeds are growing in the corner of your garden.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Water all of your carrots while avoiding the dirt. We don\'t want to waste any water!</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Use <code>span</code> to water your carrots.</p>',
  ...
  },
  {
    name: 'grid-area 2',
    instructions: {
      'nh': '<p>How about multiple items? You can overlap them without any trouble. Define a second area that covers all of the unwatered carrots.</p>',
  ...
  },
  {
    name: 'order 1',
    instructions: {
      'nh': '<p>Right now, the carrots in the second column are being poisoned and the weeds in the last column are being watered. Fix this right away!</p>',
  ...
  },
  {
    name: 'order 2',
    instructions: {
      'nh': '<p>Now the water and poison are alternating, even though all of the weeds are at the start of your garden. Remedy this.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Up to this point, you\'ve had your garden set up as a grid with five columns, each 20% of the full width, and five rows, each 20% of the full height.</p><p>This was done with the rules <code>grid-template-columns: 20% 20% 20% 20% 20%;</code> and <code>grid-template-rows: 20% 20% 20% 20% 20%;</code> Each rule has five values which create five columns, each set to 20% of the overall width of the garden.</p><p>But you can set the grid up however you like. ',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Specifying a bunch of columns with identical widths can get tedious. Create eight columns each with 12.5% width. This way you won\'t overwater your garden.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p><code>***</code> doesn\'t just accept values in percentages, but also length units like pixels and ems. You can even mix different units together.</p><p>Here, set three columns to <code>100px</code>, <code>3em</code>, and <code>40%</code> respectively.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Here, weeds make up the left 1/6 of your first row and carrots the remaining 5/6. Create two columns with these widths using <code>fr</code> units.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>When columns are set with pixels, percentages, or ems, any other columns set with <code>fr</code> will divvy up the space that\'s left over.</p><p>Here the carrots form a 50 pixel column on the left, and the weeds a 50 pixel column on the right. With <code>***</code>, create these two columns, and use <code>fr</code> to make three more columns that take up the remaining space in between.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Now there is a 75 pixel column of weeds on the left side of your garden. 3/5 of the remaining space is growing carrots, while 2/5 has been overrun with weeds.</p><p>Use <code>***</code> with a combination of <code>px</code> and <code>fr</code> units to make the necessary columns.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Water all but the top 50 pixels of your garden. Note that the water is set to fill only your 5th row, so you\'ll need to create 5 rows in total.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Water an area that includes the top 60% and left 200 pixels of your garden.</p>',
  ...
  },
  {
    ...
    instructions: {
      'nh': '<p>Your garden is looking great. Here you\'ve left a 50 pixel path at the bottom of your garden and filled the rest with carrots.</p><p>Unfortunately, the left 20% of your carrots have been overrun with weeds.</p>',
