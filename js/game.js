...
var game = {
  language: window.location.hash.substring(1) || 'nh',
  ...
  setHandlers: function() {
    ...
    $('#labelReset').on('click', function() {
      var warningReset = messages.warningReset[game.language] || messages.warningReset.nh;
    ...
    $(window).on('beforeunload', function() {
      ...
      game.language = window.location.hash.substring(1) || 'nh';
      game.translate();
  ...
  loadLevel: function(level) {
    ...
    var instructions = level.instructions[game.language] || level.instructions.nh;
      ...
      if (text in docs) {
        ...
        code.on('mouseenter', function(e) {
          if ($('#instructions .tooltip').length === 0) {
            var html = docs[text][game.language] || docs[text].nh;
  ...
  translate: function() {
    document.title = messages.title[game.language] || messages.title.nh;
    ...
    $('.translate').each(function() {
      ...
      var text = messages[label][game.language] || messages[label].nh;
...
$(document).ready(function() {
  ...
  if (!('gridArea' in d)) {
    var warning = messages.warningUnsupported[game.language] || messages.warningUnsupported.nh;
